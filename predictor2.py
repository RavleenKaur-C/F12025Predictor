...
# Get average sector times per driver for a given race
...
# Combine qualifying with wet score and sector time features
...
if __name__ == "__main__":
    ...
    X_final = full_merged[
        ["QualifyingTime (s)", "WetPerformanceScore", "Sector1Time (s)", "Sector2Time (s)", "Sector3Time (s)"]]
